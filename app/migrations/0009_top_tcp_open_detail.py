# Generated by Django 4.2.15 on 2025-03-24 21:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0008_top_icmp_open_detail'),
    ]

    operations = [
        migrations.CreateModel(
            name='Top_TCP_Open_Detail',
            fields=[
                ...
                ('TCP_Open_Val', models.PositiveBigIntegerField(blank=True, default=0, null=True)),
            ],
            options={
